...
model.fc = new_fc
# read model
model.load_state_dict(torch.load("resnet_to_cat12_1.pth"))
model = model.cuda()
...
opt.load_state_dict(torch.load("opt_to_cat12_1"))
...
torch.save(model.state_dict(), "resnet_to_cat12_2.pth")
torch.save(model.state_dict(), "opt_to_cat12_2.pth")
